...
# Вычисляет нанесеный персонажем урон.
...
# Вычисляет количество урона заблокированного персонажем.
...
# Вычисляет эффект от использования специального умения персонажа.
...
# Управление действиями персонажа.
